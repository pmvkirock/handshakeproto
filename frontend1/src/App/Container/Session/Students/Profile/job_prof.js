...
class Education extends React.Component {
  ...
  insertExp = e => {
    ...
    axios
      .post(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/insertExpInfo',
        data
      )
      .then(response => {
  ...
  updatePers = e => {
    ...
    axios
      .post(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/updateExpInfo',
        data
      )
      .then(response => {
        console.log('Status Code : ', response.status);
  ...
  getInfo = () => {
    ...
    axios
      .post(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/stud_exp',
        data
      )
      .then(response => {
