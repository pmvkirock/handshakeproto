...
class Education extends React.Component {
  ...
  updatePers = e => {
    ...
    axios
      .post(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/updateEduInfo',
        data
      )
      .then(response => {
  ...
  deleteEdu = e => {
    ...
    axios
      .post(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/deleteEduInfo',
        data
      )
      .then(response => {
        console.log('Status Code : ', response.status);
  ...
  insertEdu = e => {
    ...
    axios
      .post(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/insertEduInfo',
        data
      )
      .then(response => {
        console.log('Status Code : ', response.status);
  ...
  getInfo = () => {
    ...
    axios
      .post(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/stud_edu',
        data
      )
      .then(response => {
