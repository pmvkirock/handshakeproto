...
class apply extends React.Component {
  ...
  job_cat = e => {
    ...
    if (
      ...
      axios
        .post(
          'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/updateApplied',
          data
        )
        .then(response => {
  ...
  applyJob = () => {
    ...
    axios
      .get(
        'http://ec2-3-135-239-183.us-east-2.compute.amazonaws.com:8000/getApplied?idcompany=' +
          cookie.load('cookie') +
          '&idjob=' +
          this.props.idjob
      )
